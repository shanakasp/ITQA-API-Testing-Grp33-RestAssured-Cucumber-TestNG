...
Feature: Book Update Scenarios by Member1
  Scenario Outline: Book Update by Different User Types
    ...
    Examples:
      ...
      | admin      | password | admin        | 3      | Brave New World 345   | Aldous Huxley 15   | 200                |
      | user       | password | user         | 3      | The Alchemist    s4    | Paulo Coelho    15   | 403                |
      | guest      | password | guest       | 3      | The Alchemist    s3    | Paulo Coelho    15   | 401                |
  ...
  Scenario Outline: Book Update by Different validation Types
    ...
    Examples:
      | username   | password | userType     | bookId | bookTitle            | bookAuthor          | expectedStatusCode |
      | admin      | password | admin        |   3    |                      | Aldous Huxley asda  | 422             |
      | admin      | password | admin        |   3    |      test book       |                     | 422             |
